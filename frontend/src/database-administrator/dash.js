...
const DatabaseAdmin = ({admin}) => {
  ...
  const [userData, setuserData] = useState({patients: []});
              ...
              <div className="projects-section-line">
                <div className="projects-status">
                  <div className="item-status">
                    <span className="status-number">{userData.patients.length}</span>
                  ...
                  return (
                    ...
                    <div className="project-box" style={{ backgroundColor: bckgColors[random()] }}>
                      ...
                      <div className="project-box-content-header">
                        ...
                        <p className="box-content-subheader">Address: {patient.address}</p>
                      </div>
